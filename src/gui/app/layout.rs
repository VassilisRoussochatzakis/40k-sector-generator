                    ...
                    .clicked()
                {
                    if let Some(id) = app.sector_selected.clone() {
                        app.view = View::System {
                            system_id: id,
                            selection: crate::gui::system_view::SystemSelection::None,
                        };
                    }
                }
                if ui
...
fn draw_main_view(app: &mut App, ctx: &egui::Context) {
    match app.view.clone() {
        ...
        View::Planner => crate::gui::app::planner_view::ui(app, ctx),
        View::Dashboard => app.draw_dashboard_layout(ctx),
        View::Factions => crate::gui::app::factions_view::ui(app, ctx),
        View::Relations => crate::gui::app::relations_view::ui(app, ctx),
        View::Regions => crate::gui::app::regions_view::ui(app, ctx),
        View::Trade => crate::gui::app::trade_view::ui(app, ctx),
